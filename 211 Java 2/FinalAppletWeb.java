...
public class FinalAppletWeb extends JApplet
{
   ...
   public void switchButtons(){              //this method randomizes the button titles, not the buttons themselves.
      ...
      for (int i = 0; i < 16; i++)
         {
         int red = (r.nextInt(150)+ 70);
         int green = 0;
         int blue = 0/*r.nextInt(255)*/;
         
         Color randColor = new Color(red, green, blue);
         
         buttonArray[(i + rand + 1)%16].setText("Wrong");
         ...
         buttonArray[(rand)%16].setText("Right");
         buttonArray[(rand)%16].setBackground(Color.RED);
         responseNum++;
