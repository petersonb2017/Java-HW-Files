...
public class MotionWithKeyBindings
{
	...
	public static void main(String[] args)
	{
		EventQueue.invokeLater(new Runnable()
		{
            ...
            JLabel obsticle = new JLabel( new Obsticle(Color.RED, 20, 20) );
				component.setSize( component.getPreferredSize() );
            obsticle.setSize(component.getPreferredSize());
				component.setLocation(100, 100);
            obsticle.setLocation(250, 250);
				content.add(component);
            content.add(obsticle);
   ...
   static class Obsticle implements Icon
	{
		private Color color;
		private int width;
		private int height;

		public Obsticle(Color color, int width, int height)
		{
			this.color = color;
			this.width = width;
			this.height = height;
