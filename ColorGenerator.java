...
public class ColorGenerator  
{
   public static void main(String[] args)   // main is a method
   {
      ...
      do {
         ...
         System.out.println("Enter the Red pixel intensity value (an interger between 0 and 256)");
         redGuess = in.nextInt();
         System.out.println("Enter the Green pixel intensity value (an interger between 0 and 256)");
         greenGuess = in.nextInt();
         System.out.println("Enter the Blue pixel intensity value (an interger between 0 and 256)");
